...
function initProjectPage() {
    ...
    const run = ()=>{
        ...
        if (indicatorShells.length && projectsSectionShell) {
            ...
            projectsSectionTrigger = (0, _scrollTrigger.ScrollTrigger).create({
            ...
            if (linksIntroShell) {
                linksIntroTrigger = (0, _scrollTrigger.ScrollTrigger).create({
...
},{"gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","gsap/SplitText":"63tvY","./utils/workLinksModule":"dJji4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dJji4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
