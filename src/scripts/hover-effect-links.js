...
*/
  ...
  var hoverTarget = opts.hoverTarget;
  ...
  if (!hoverTarget) {
    console.warn("hoverTarget missing");
    return;
  }
...
/*
  ...
  */
  ...
  renderer.domElement.className = 'canva';
  ...
  if (userHover) {
    hoverTarget.addEventListener("mouseenter", transitionIn);
    hoverTarget.addEventListener("touchstart", transitionIn);
    hoverTarget.addEventListener("mouseleave", transitionOut);
    hoverTarget.addEventListener("touchend", transitionOut);
  }
